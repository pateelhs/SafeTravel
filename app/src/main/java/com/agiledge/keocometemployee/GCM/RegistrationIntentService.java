...
//            sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        try {
            ...
            //  decode(Environment.getExternalStorageDirectory().getPath() + "/saved_signature/mytxt.txt", Environment.getExternalStorageDirectory().getPath() + "/saved_signature/pdf10.pdf");
